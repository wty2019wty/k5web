...
export default {
  ...
  'image.fsEnter': 'Landscape fullscreen',
  'image.fsHint': 'Tap to edit in landscape fullscreen',
  'image.fsBar': '128 × 64 · left: draw · right: move pen',
  'image.fsExit': 'Exit fullscreen',
  'image.fsZoneDraw': 'Draw',
  'image.fsZoneMove': 'Move',
  'image.writing': 'Writing...',
  'image.threshold': 'Color threshold: ',
